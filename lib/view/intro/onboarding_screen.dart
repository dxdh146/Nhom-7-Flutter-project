  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: IntroductionScreen(
        pages: pages,
        done: Text(tr('onboarding_done'), style: const TextStyle(color: Colors.black)),
        onDone: () => Navigator.pushReplacementNamed(context, '/login'),
        next: Text(tr('onboarding_next'), style: const TextStyle(color: Colors.black)),
        skip: Text(tr('onboarding_skip'), style: const TextStyle(color: Colors.black)),
        showSkipButton: true,
