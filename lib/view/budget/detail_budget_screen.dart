                          ...
                          child: Tooltip(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '${formatAmount(viewModel.actualSpending)}${tr('₫_day')}',
                                  style: const TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 16),
                                ),
                          ...
                          child: Tooltip(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '${formatAmount(viewModel.recommendedSpending)}${tr('₫_day')}',
                                  style: const TextStyle(
                                      fontWeight: FontWeight.bold,
                                      fontSize: 16),
                                ),
                        ...
                        if (viewModel.previousPeriods.isNotEmpty)
                          GestureDetector(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Expanded(child: Text(tr('previous_periods'), style: const TextStyle(fontSize: 16),)),
                        ...
                        if (viewModel.filteredTransactions.isNotEmpty)
                          GestureDetector(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Expanded(child: Text(tr('transaction_details'), style: const TextStyle(fontSize: 16),)),
